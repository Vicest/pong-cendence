...
<div class="card grid">
    <button class="grid-item {showDirect ? 'active' : ''} " on:click={() => showComponent('Direct')}>Mensajes Directos</button>
    <button class="grid-item {showGroup ? 'active' : ''} " on:click={() => showComponent('Group')}>Grupos</button>
