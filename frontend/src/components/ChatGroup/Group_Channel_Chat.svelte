<script lang="ts">
	...
	import { chat_history, chat_receptor } from '../../store/Chat';
	...
	function addMessage(): void {
		...
		let msg = {
			sender: $currentUser,
			receiver: $chat_receptor,
			content: currentMessage
		};

		Api.post('/chat/chat_messages', msg)
			.then((response) => {
