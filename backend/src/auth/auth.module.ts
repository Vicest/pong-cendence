...
@Module({
	...
	providers: [AdminStrategy, AdminGuard, Intra42Strategy, IntraAuthGuard, JwtStrategy, JwtGuard, JwtRefreshStrategy, JwtRefreshGuard, Jwt2faStrategy, Jwt2faAuthGuard, AuthService, Serializer],
